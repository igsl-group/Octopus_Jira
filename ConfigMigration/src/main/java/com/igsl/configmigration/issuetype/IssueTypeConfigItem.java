...
public class IssueTypeConfigItem extends JiraConfigItem {
	...
	private AvatarConfigItem avatarConfigItem;
	private String name;
	private String id;
	...
	public void fromJiraObject(Object o, Object... params) throws Exception {
		...
		this.avatarConfigItem = new AvatarConfigItem();
		Avatar av;
	...
	public AvatarConfigItem getAvatarConfigItem() {
		return avatarConfigItem;
	}

	public void setAvatarConfigItem(AvatarConfigItem avatarConfigItem) {
