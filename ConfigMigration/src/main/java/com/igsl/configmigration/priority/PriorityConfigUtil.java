...
public class PriorityConfigUtil extends JiraConfigUtil {
	...
	private static final Logger LOGGER = Logger.getLogger(PriorityConfigUtil.class);
	...
	public TypeReference<?> getTypeReference() {
		return new TypeReference<Map<String, PriorityConfigItem>>() {};
	}
	...
	public Map<String, JiraConfigItem> readAllItems(Object... params) throws Exception {
		...
		for (Priority p : PRIORITY_MANAGER.getPriorities()) {
			PriorityConfigItem item = new PriorityConfigItem();
	...
	public Object merge(JiraConfigItem oldItem, JiraConfigItem newItem) throws Exception {
		...
		PriorityConfigItem src = (PriorityConfigItem) newItem;
		if (original != null) {
			// Update
