...
public class ResolutionConfigUtil extends JiraConfigUtil {

	private static final Logger LOGGER = Logger.getLogger(ResolutionConfigUtil.class);
	...
	public TypeReference<?> getTypeReference() {
		return new TypeReference<Map<String, ResolutionConfigItem>>() {};
	}
	...
	public Object merge(JiraConfigItem oldItem, JiraConfigItem newItem) throws Exception {
		...
		ResolutionConfigItem src = (ResolutionConfigItem) newItem;
		if (original != null) {
			// Update
