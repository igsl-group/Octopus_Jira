...
public class PluginConfigUtil extends JiraConfigUtil {

	private static final Logger LOGGER = Logger.getLogger(PluginConfigUtil.class);
	...
	public TypeReference<?> getTypeReference() {
		return new TypeReference<Map<String, PluginConfigItem>>() {};
	}
	...
	public Object merge(JiraConfigItem oldItem, JiraConfigItem newItem) throws Exception {
		PluginConfigItem src = (PluginConfigItem) newItem;
