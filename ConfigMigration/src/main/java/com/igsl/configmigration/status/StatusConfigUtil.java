...
public class StatusConfigUtil extends JiraConfigUtil {

	private static final Logger LOGGER = Logger.getLogger(StatusConfigUtil.class);
	...
	public TypeReference<?> getTypeReference() {
		return new TypeReference<Map<String, StatusConfigItem>>() {};
	}
	...
	public Object merge(JiraConfigItem oldItem, JiraConfigItem newItem) throws Exception {
		...
		StatusConfigItem src = (StatusConfigItem) newItem;
		String name = src.getName();
		String description = src.getDescription();
		StatusCategoryConfigItem category = src.getStatusCategoryConfigItem();
