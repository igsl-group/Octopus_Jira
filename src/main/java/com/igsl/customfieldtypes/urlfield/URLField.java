...
@Named
public class URLField implements CustomFieldType<List<URLFieldData>, URLFieldData> {

	private static final Logger LOGGER = LoggerFactory.getLogger(URLField.class);
	
	protected static final String KEY_DISPLAY_TEXT = "displayText";
	protected static final String KEY_URL = "url";
	
	protected static final String CONFIG_MAX = "URLField.config.max";
	...
	@Override
	public void createValue(CustomField arg0, Issue arg1, List<URLFieldData> arg2) {
	...
	@Override
	public String getChangelogString(CustomField arg0, List<URLFieldData> arg1) {
		if (arg1 != null) {
			StringBuilder sb = new StringBuilder();
			for (URLFieldData item : arg1) {
	...
	@Override
	public String getChangelogValue(CustomField arg0, List<URLFieldData> arg1) {
		if (arg1 != null) {
			StringBuilder sb = new StringBuilder();
			for (URLFieldData item : arg1) {
	...
	public List<FieldConfigItemType> getConfigurationItemTypes() {
		...
		result.add(new URLFieldConfigItemType());
		return result;
	}

	@Override
	public List<URLFieldData> getDefaultValue(FieldConfig arg0) {
		...
		try {
			Type collectionType = new TypeToken<List<URLFieldData>>() {}.getType();
			List<URLFieldData> result = new Gson().fromJson(s, collectionType);
	...
	@Override
	public URLFieldData getSingularObjectFromString(String arg0) throws FieldValidationException {
		LOGGER.debug("getSingularObjectFromString: " + arg0);
		URLFieldData value = URLFieldData.fromString(arg0);
		LOGGER.debug("getSingularObjectFromString = " + value);
		return value;
	}

	@Override
	public String getStringFromSingularObject(URLFieldData arg0) {
	...
	public Object getStringValueFromCustomFieldParams(CustomFieldParams arg0) {
		...
		List<URLFieldData> result = getValueFromCustomFieldParams(arg0);
	...
	@Override
	public List<URLFieldData> getValueFromCustomFieldParams(CustomFieldParams arg0) throws FieldValidationException {
		...
		Collection<String> displayTextList = arg0.getValuesForKey(KEY_DISPLAY_TEXT);
		Collection<String> urlList = arg0.getValuesForKey(KEY_URL);
		List<URLFieldData> itemList = null;
		if (urlList != null) {
			itemList = new ArrayList<URLFieldData>();
			for (String url : urlList) {
				URLFieldData item = new URLFieldData();
				item.setUrl(url);
				itemList.add(item);
			}
			int idx = 0;
			for (String displayText : displayTextList) {
				itemList.get(idx).setDisplayText(displayText);
				idx++;
			}
		}
	...
	@Override
	public List<URLFieldData> getValueFromIssue(CustomField arg0, Issue arg1) {
		LOGGER.debug("getValueFromIssue: " + arg0 + ", " + arg1);
		List<URLFieldData> result = null;
		if (arg1 != null) {
			...
			if (values != null && !values.isEmpty()) {
				result = new ArrayList<URLFieldData>();
				for (Object o : values) {
					if (o != null) {
						URLFieldData item = URLFieldData.fromString(String.valueOf(o));
						result.add(item);
					}
				}
			}
	...
	public Map<String, Object> getVelocityParameters(Issue arg0, CustomField arg1, FieldLayoutItem arg2) {
		...
		result.put(CONFIG_MAX, settings.get(CONFIG_MAX));
	...
	@Override
	public void setDefaultValue(FieldConfig arg0, List<URLFieldData> arg1) {
	...
	@Override
	public void updateValue(CustomField arg0, Issue arg1, List<URLFieldData> arg2) {
	...
	@Override
	public boolean valuesEqual(List<URLFieldData> arg0, List<URLFieldData> arg1) {
